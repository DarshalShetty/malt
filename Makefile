...
ACCELERATED_TENSORS_SOURCES=\
  ...
  $(ACCELERATED_TENSORS_DIR)/2-acc-fun-to-prealloc.rkt\
  $(ACCELERATED_TENSORS_DIR)/2-acc-kernels.rkt\
  ...
  $(ACCELERATED_TENSORS_DIR)/D-fun-to-prealloc.rkt\
  $(ACCELERATED_TENSORS_DIR)/D-extend.rkt\
  $(ACCELERATED_TENSORS_DIR)/ext2-strides.rkt\
...
ACCELERATED_SOURCES=$(ACCELERATED_TENSORS_SOURCES)\
	...
	$(ACCELERATED_EXT_OPS_SOURCES)\
	$(ACCELERATED_LOADERS)\
  $(ACCELERATED_DIR)/kernel-name-gen.rkt
