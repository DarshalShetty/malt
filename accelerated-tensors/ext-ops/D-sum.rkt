...
(define sum-1
  (prim1 sum-1-ρ sum-1-ρ-acc sum-1-∇ sum-1-∇-acc sum-shape))

(define d-sum
  (ext1 sum-1 1))

(define sum-ρ
  (ext1-ρ sum-1-ρ sum-1-ρ-acc 1 sum-shape))
...
(define sum-cols-2
  (prim1 sum-cols-2-ρ sum-cols-2-ρ-acc sum-cols-2-∇ sum-cols-2-∇-acc sum-cols-shape))

(define d-sum-cols
  (ext1 sum-cols-2 2))

(define sum-cols-ρ
  (ext1-ρ sum-cols-2-ρ sum-cols-2-ρ-acc 2 sum-cols-shape))
